        ...
        <div className="max-w-3xl">
          ...
          <div className="space-y-10 text-text-muted leading-relaxed">
            ...
            <p>
              ...
              (the &ldquo;Service&rdquo; operated by &ldquo;Telegram
              Channels&rdquo;).
            </p>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="mb-3">
                    ...
                    to contact or identify you (&ldquo;Personal Data&rdquo;).
                ...
                <div>
                  ...
                  <p>
                    ...
                    accessed and used (&ldquo;Usage Data&rdquo;). This Usage
            ...
            <Section title="Use of Collected Data">
              <p className="mb-3">
                Telegram Channels uses the collected data for various purposes:
              </p>
              <ul className="list-disc list-inside space-y-1.5 ml-2">
            ...
            <Section title="Transfer Of Data">
              ...
              <p className="mb-3">
                ...
                Data, and process it there.
              </p>
              <p>
                Your consent to this Privacy Policy followed by your submission
                of such information represents your agreement to that transfer.
                Telegram Channels will take all steps reasonably necessary to
            ...
            <Section title="Disclosure Of Data">
              <div>
                ...
                <p className="mb-3">
                  Telegram Channels may disclose your Personal Data in the good
                  faith belief that such action is necessary to:
                </p>
                <ul className="list-disc list-inside space-y-1.5 ml-2">
                  <li>To comply with a legal obligation</li>
                  <li>
                    To protect and defend the rights or property of Telegram
                    Channels
                  </li>
                  <li>
            ...
            <Section title="Analytics">
              ...
              <ul className="list-disc list-inside space-y-1.5 ml-2">
                <li>
                  ...
                  reports website traffic. Google uses the data collected to
                  track and monitor the use of our Service. This data is shared
                  with other Google services. Google may use the collected data
